...
<!-- Oscar modified: FAX input doesn't show CCC anymore -->
<dl>
	<dt><?php echo $this->lang->line('fax_number'); ?>: </dt>
	<dd><input type="text" name="client_fax" id="client_fax" value="<?php echo $this->mdl_clients->form_value('client_fax'); ?>" /></dd>
</dl>

<dl>
	<dt><?php echo $this->lang->line('client_ccc'); ?>: </dt>
...
<!-- End Oscar modified-->
<dl>
	<dt><?php echo $this->lang->line('num_iban'); ?>: </dt>
	<dd><input type="text" name="client_iban" id="client_iban" value="<?php echo $this->mdl_clients->form_value('client_iban'); ?>" /></dd>
</dl>
