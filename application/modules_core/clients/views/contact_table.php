...
<script language="JavaScript">
 function aviso(url)
 {
   if (!confirm("ATENCIÓ!! Esteu segurs d'eliminar aquest article?")) 
   {
    return false;
   }
   else 
...
<table style="width: 100%;">
	...
	<tr>
		...
		<td class="last">
			...
			<a href="javascript:;" onclick="aviso('<?php echo site_url('clients/contacts/delete/client_id/' . $contact->client_id . '/contact_id/' . $contact->contact_id); ?>');  return false;"><?php echo icon('delete'); ?></a>
		</td>
	</tr>
	<?php } ?>
</table>
