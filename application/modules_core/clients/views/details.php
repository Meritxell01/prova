				...
				<div id="tabs">
					...
					<div id="tab_client">
						...
						<div class="left_box">
							...
							<!--Comentem per a que no es mostri el Pais o Provincia 2 cops als detalls del client-->
							<!--<dl>
							...
							<!--Comentem per a que no es mostri el fax-->							
                            ...
                            <dl>
								...
								<dd><?php echo $client->client_ccc; ?></dd>
							</dl> 

                            <dl>
								<dt><?php echo $this->lang->line('num_iban'); ?>: </dt>
								<dd><?php echo $client->client_iban; ?></dd>
							</dl> 
