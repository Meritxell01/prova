...
<div class="grid_8" id="content_wrapper">
    ...
    <div class="section_wrapper">
        <h3 class="title_black"><?php echo $this->lang->line('list_bank'); ?>
            <?php $this->load->view('dashboard/btn_add', array('btn_value'=>$this->lang->line('add_bank_btn'))); ?>
        </h3>
            ...
            <table id="banks">
			 ...
			 <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo site_url('expenses/bank/form/bank_id/' . $bank->bank_id); ?>" title="<?php echo $this->lang->line('edit'); ?>">
                            <?php echo icon('edit'); ?>
			</a>
			<a href="<?php echo site_url('expenses/bank/delete/' . $bank->bank_id . '/bank_id/' . $bank->bank_id); ?>" title="<?php echo $this->lang->line('delete'); ?>" onclick="javascript:if(!confirm('<?php echo $this->lang->line('confirm_delete'); ?>')) return false">
