	...
	function index() {
		...
		$params = array(
			'open'		=> array(
				'limit'	=>	10,
				'where'	=>	array(
					'mcb_invoice_statuses.invoice_status_type'		=>	$this->mdl_mcb_data->setting('default_open_status_id'),
			...
			'closed'	=>	array(
				'limit'	=>	10,
				'where'	=>	array(
					'mcb_invoice_statuses.invoice_status_type'		=>	$this->mdl_mcb_data->setting('default_closed_status_id'),
					'mcb_invoices.client_id'						=>	$this->session->userdata('client_id'),
					'mcb_invoices.invoice_is_quote'					=>	0
				),
				'set_client'	=>	TRUE
