...
<div class="grid_8" id="content_wrapper">
	...
	<div class="section_wrapper">
		...
		<div class="content toggle no_padding">
			...
			<?php $this->load->view('invoices/invoice_table', array('invoices'=>$overdue_invoices,'table_id'=>"overdue_invoices",'show_id'=>true,'show_user'=>true)); ?>
	...
	<div class="section_wrapper">
		...
		<div class="content toggle no_padding">
			...
			<?php $this->load->view('invoices/invoice_table', array('invoices'=>$open_invoices,'table_id'=>"open_invoices",'show_id'=>true,'show_user'=>true)); ?>
	...
	<div class="section_wrapper">
		...
		<div class="content toggle no_padding">
			...
			<?php $this->load->view('invoices/invoice_table', array('invoices'=>$pending_invoices,'table_id'=>"pending_invoices",'show_id'=>true,'show_user'=>true)); ?>
	...
	<div class="section_wrapper">
		...
		<div class="content toggle no_padding">
			...
			<?php $this->load->view('invoices/invoice_table', array('invoices'=>$closed_invoices,'table_id'=>"closed_invoices",'show_id'=>true,'show_user'=>true)); ?>
