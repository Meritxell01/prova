...
<div class="grid_8" id="content_wrapper">
	...
	<div class="section_wrapper">
		...
		<h3 class="title_black"><?php echo $this->lang->line('inventory_types'); ?><?php $this->load->view('dashboard/btn_add', array('btn_value'=>$this->lang->line('add'))); ?></h3>
		...
		<div class="content toggle no_padding">
			...
			<table>
				...
				<tr>
					...
					<td><?php echo $inventory_type->inventory_type; ?></td>
					<td class="last">
