		...
		<div class="section_wrapper">
			...
			<div class="content toggle">
				...
				<dl>
					...
					<!--Aquí afegim el camp numero de sèrie-->
					<!--<dl>
						<dt><label><?php echo $this->lang->line('item_serial'); ?>: </label></dt>
						<dd><input type="text" name="inventory_serial" id="inventory_serial" value="<?php echo $this->mdl_inventory->form_value('inventory_serial'); ?>" /></dd>
					</dl>-->
					
					<dl>
						<dt><label><?php echo $this->lang->line('item_description'); ?></label></dt>
						<dd><textarea name="inventory_description" cols="50" rows="5" id="inventory_description"><?php echo $this->mdl_inventory->form_value('inventory_description'); ?></textarea></dd>
					</dl>
