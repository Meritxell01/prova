    ...
    public function check_email($email) {
        ...
        foreach ($email as $address) {
            ...
            if (!valid_email($address)) {
                ...
                $this->form_validation->set_message('check_email', 'El camp A:* no pot contenir un caracter al final de la línea');
                
                /*Aquí diem que al camp enviar factura per correu a l'apartat A*(Destinatari) no pot estar amb un caracter al darrera com ara una (,)
