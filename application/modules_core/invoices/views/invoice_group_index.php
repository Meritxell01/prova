...
<script language="JavaScript">
 function aviso(url)
 {
   if (!confirm("ATENCIÓ!! Esteu segurs d'eliminar aquest grup de factures?")) 
   {
    return false;
   }
   else 
			...
			<table>
				...
				<tr>
					...
					<td class="last">
						...
						<a href="javascript:;" onclick="aviso('<?php echo site_url('invoices/invoice_groups/delete/invoice_group_id/'.$invoice_group->invoice_group_id); ?>');  return false;"><?php echo icon('delete'); ?></a>
