...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table width="100%">
		  <tr>
		   <td width="45%"  valign="top" class= "tamanyLletra">
		     <p>
            ...
            <tr><td>CAIXABANK: </td><td><?php echo $this->mdl_mcb_data->get('iban1');?><!--ES04 2100 0019 4002 0070 2332--></td></tr>
            <!--<tr><td>BANC SABADELL: </td><td>0081-0130-06-0001308235</td></tr>-->
            <tr><td>BANC SABADELL: </td><td><?php echo $this->mdl_mcb_data->get('iban2');?><!--ES94 0081 0130 0600 0130 8235--></td></tr>
		  ...
		  <td width="40%" align="left" valign="top" class= "tamanyLletra">
			...
			<b><?php echo invoice_to_client_name($invoice); ?><br />
			   ...
			   <?php echo $invoice->client_email_address; ?>
