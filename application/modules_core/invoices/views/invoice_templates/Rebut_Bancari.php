...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table width="100%">
		  <tr>
		   <td width="50%"  valign="top" class= "tamanyLletra">
		     <p>
            ...
            <?php $client_ccc= substr(invoice_to_fax_number($invoice),0,-6); ?>
            <?php $iban_client= substr($invoice->client_iban,0,-6); ?>
            <b>Forma de pagament</b>
             <table>
               <tr><td>REBUT BANCARI: </td><td><?php //echo $client_ccc."******";?><?php echo $iban_client."******";?></td></tr>
            </table>
		    </p>
		  </td>
          <td width="40%">
