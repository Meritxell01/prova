...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table width="100%">
		  <tr>
		   <td width="40%"  valign="top" class= "tamanyLletra">
			...
			<?php echo $this->lang->line('quote_date'); ?>:
		...
		<br />
		<!--AQUÍ DONEM L'ALÇADA PER A QUE NO ENS FACI 2 FULLES EL PDF-->
		<div id= "contenidor_dades_legals" style="height:610px; min-height:610px;">
		...
		<table style="width: 100%;">
            ...
            <tr style="height:140px;" height="140px">
				...
				<td class= "espai">
					...
					/*COMENTEM EL SERIAL PER A QUE NO ES MOSTRI AL PRESSUPOST*/
					/*."<br>-s/n:".$item->item_serial;*/
					}else{
					echo invoice_item_description($item);	
					}
					?>
...
<tr>
			...
			<tr>
                ...
                <div>
					<h3><b><font color="#FF0000">LA VIGÈNCIA D'AQUEST PRESSUPOST ÉS FINS LA DATA <?php echo format_date($invoice->invoice_due_date); ?></font></b></h3>
				</div>
                <hr />
