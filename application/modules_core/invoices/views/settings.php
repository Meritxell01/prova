...
<dl>
    <dt><?php echo $this->lang->line('iban')." 1"; ?></dt>
    <dd><input type="text" name="iban1" value="<?php echo $this->mdl_mcb_data->setting('iban1'); ?>" /></dd>    	    
</dl>


<dl>
    <dt><?php echo $this->lang->line('iban')." 2"; ?></dt>
    <dd><input type="text" name="iban2" value="<?php echo $this->mdl_mcb_data->setting('iban2'); ?>" /></dd> 
</dl>
<!-- fi ibans  -->
