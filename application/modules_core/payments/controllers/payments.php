...
class Payments extends Admin_Controller {
    ...
    function form() {
        ...
        if (!$this->mdl_payments->validate()) {
            ...
            //Oscar: Actualitzo el camp invoice_status_id segons si el checkbox està activat (3) o desactivat (0)
            $consulta  =$this->mdl_invoices->set_invoice_status_id($invoice_id,$this->input->post('invoice_status_id'));
            //die($consulta);
    ...
    function get_amount_from_invoice_id(){
        $this->load->model('invoices/mdl_invoices');
        ...
        //echo $invoice_id;
            if ($invoice_id) {
                ...
                $data['invoice'] = $this->mdl_invoices->get($params);
                print_r($data['invoice']->invoice_balance);
