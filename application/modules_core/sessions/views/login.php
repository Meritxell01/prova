...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<!--[if IE 8]><link rel="stylesheet" type="text/css" media="screen" href="<?php echo base_url(); ?>assets/style/css/ie8.css" /><![endif]-->
		<!--[if IE 9]><link rel="stylesheet" type="text/css" media="screen" href="<?php echo base_url(); ?>assets/style/css/ie9.css" /><![endif]-->
	...
	<body>
		...
		<div class="container_10" id="center_wrapper">
                        <center><?php echo '<img src="' . base_url() . 'assets/style/img/logo.png" style="margin-top: 10px; margin-right: 85px"/>'; ?></center>
			
			<div class="grid_5 push_3" id="content_wrapper">

				<div class="section_wrapper">

					<h3 class="title_black" align="center"><?php echo $this->lang->line('log_in_2'); ?></h3>                                    
